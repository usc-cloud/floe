    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            FloeGraph fg = (FloeGraph) um.unmarshal(new StreamSource(
                    new File("C:\\Users\\charith\\Documents\\Projects\\USC\\floe\\trunk\\applications\\patterns\\" +
                            "experiment-flow\\FloeGraph\\application.xml")));
            ...
            WebResource r = c.resource("http://floe.cloudapp.net:45000/Coordinator/createFloe");
