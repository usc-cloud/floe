...
package edu.usc.pgroup.floe.api.framework.manager.infraManager.infraHandler;
...
public interface InfraHandler
{
	...
	AcquireResourceResponse acquireResource(AcquireResourceRequest containerRequests);
