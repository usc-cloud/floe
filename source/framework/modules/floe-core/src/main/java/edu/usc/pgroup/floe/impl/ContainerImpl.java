...
public class ContainerImpl implements Container {
    ...
    ContainerImpl() {
        ...
        try {
            ...
            if(environment.getSystemConfigParam(GopherInfraHandler.PARTITION) != null) {
                if(allocated.getOptionalConfiguration() == null) {
                    allocated.setOptionalConfiguration(new Node.Configuration());
                }

                allocated.getOptionalConfiguration().getParams().put(GopherInfraHandler.PARTITION,
                        environment.getSystemConfigParam(GopherInfraHandler.PARTITION));

                if(available.getOptionalConfiguration() == null) {
                    available.setOptionalConfiguration(new Node.Configuration());
                }

                available.getOptionalConfiguration().getParams().put(GopherInfraHandler.PARTITION,
                        environment.getSystemConfigParam(GopherInfraHandler.PARTITION));
